 ...
 *             ORANGE: 8, PURPLE: 9, LIME: 10, BROWN: 11, DARKBLUE: 12, DARKGREEN: 13,    GRAY: 14, DARKGRAY: 15]
 */
#define MARLIN_BACKGROUND_COLOR 12  // Marlin Mode background color (Default: 1)
 ...
 */
#define MAX_TEMP {275, 275, 275, 275, 275, 275, 125, 60}  // Default: {275, 275, 275, 275, 275, 275, 150, 60}
...
#define Y_MAX_POS 225  // Default: 235
 ...
 */
#define PREHEAT_LABELS {"PLA", "ABS", "PET"}  // Default: {"PLA", "PETG", "ABS", "WOOD", "TPU", "NYLON"}
#define PREHEAT_HOTEND {190,   240,    255}      // Default: {200,   240,    230,   170,    220,   250}
#define PREHEAT_BED    { 60,    100,     90}      // Default: { 60,    70,     90,    50,     50,    90}
