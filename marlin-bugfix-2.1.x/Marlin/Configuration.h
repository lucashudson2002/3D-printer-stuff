...
#define STRING_CONFIG_H_AUTHOR "(Lucas Hudson, Ender-3)" // EU
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0 // EU
#endif
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 // EU
#define BAUDRATE_2 250000   // :[2400, 9600, 19200, 38400, 57600, 115200, 250000, 500000, 1000000] Enable to override BAUDRATE // EU
...
#define CUSTOM_MACHINE_NAME "Barbie" // EU
 ...
 */
#define X_DRIVER_TYPE  TMC2209 // EU
#define Y_DRIVER_TYPE  TMC2209 // EU
#define Z_DRIVER_TYPE  TMC2209 // EU
...
#define E0_DRIVER_TYPE TMC2209 // EU
...
#define HEATER_0_MAXTEMP 300 // EU
...
//#define ENDSTOPPULLUPS // EU
  ...
  #define ENDSTOPPULLUP_ZMIN_PROBE // EU
#endif
...
#define ENDSTOP_INTERRUPTS_FEATURE // EU
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 424.9 } // EU
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } // EU
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 5000 } // EU
 ...
 */
#define DEFAULT_ACCELERATION          500    // X, Y, Z and E acceleration for printing moves // EU
#define DEFAULT_RETRACT_ACCELERATION  500    // E acceleration for retracts // EU
#define DEFAULT_TRAVEL_ACCELERATION   500    // X, Y, Z acceleration for travel (non printing) moves // EU
 ...
 */
#define S_CURVE_ACCELERATION // EU
...
#define USE_PROBE_FOR_Z_HOMING // EU
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-23, -70, -3.35 } // EU
...
#define PROBE_OFFSET_XMIN -50   // (mm) // EU
#define PROBE_OFFSET_XMAX  50   // (mm) // EU
#define PROBE_OFFSET_YMIN -100   // (mm) // EU
#define PROBE_OFFSET_YMAX  100   // (mm) // EU
#define PROBE_OFFSET_ZMIN -20   // (mm) // EU
#define PROBE_OFFSET_ZMAX  20   // (mm) // EU
...
#define X_BED_SIZE 233 // EU
#define Y_BED_SIZE 226 // EU
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //#define MIN_SOFTWARE_ENDSTOP_Z // EU
...
#define AUTO_BED_LEVELING_BILINEAR // EU
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 // EU
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID // EU
 ...
 */
#define LCD_BED_LEVELING // EU

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU        // Add a menu to edit mesh points // EU
#endif

// Add a menu item to move between bed corners for manual bed adjustment
#define LCD_BED_TRAMMING // EU
...
#define HOMING_FEEDRATE_MM_M { (20*60), (20*60), (4*60) } // EU
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 // EU
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save PROGMEM.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors. // EU
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU // EU
...
#define NEOPIXEL_LED // EU
#if ENABLED(NEOPIXEL_LED)
  #define NEOPIXEL_TYPE          NEO_GRB // NEO_GRBW, NEO_RGBW, NEO_GRB, NEO_RBG, etc. // EU
                                          // See https://github.com/adafruit/Adafruit_NeoPixel/blob/master/Adafruit_NeoPixel.h
  //#define NEOPIXEL_PIN                4 // LED driving pin
  //#define NEOPIXEL2_TYPE  NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN               5
  #define NEOPIXEL_PIXELS              10 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.) // EU
  #define NEOPIXEL_IS_SEQUENTIAL          // Sequential display for temperature change - LED by LED. Disable to change all LEDs at once.
  #define NEOPIXEL_BRIGHTNESS         204 // Initial brightness (0-255) // EU
